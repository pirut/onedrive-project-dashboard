...
async function listAsyncJobs(dataverse, stepId, { since, limit }) {
...
export default async function handler(req, res) {
    ...
    try {
        ...
        logger.error("Debug Dataverse webhook jobs failed", { error: error?.message || String(error) });
