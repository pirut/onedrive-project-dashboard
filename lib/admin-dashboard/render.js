...
function renderSummaryCards({ graphEnvOk, plannerEnvOk, plannerEnvMissing, kvDiag, adminConfigured, adminUsername }) {
    return `
  <div class="grid">
    <details class="panel">
...
function renderPlannerMaintenanceSection() {
    return `
  <div class="row" style="display:flex;gap:8px;flex-wrap:wrap">
  ...
  <div class="small muted" style="margin-top:8px">
    Daily audit runs via cron to keep plan titles aligned and duplicates removed.
  </div>
  <div class="small muted" style="margin-top:6px">
    Results appear in the Planner Sync output panel.
  </div>`;
}
...
function renderDashboardPage(data) {
    const sections = [
        ...
        { id: "planner-sync", title: "Planner Sync", meta: "BC ↔ Planner", body: renderPlannerSyncSection() },
        { id: "planner-maintenance", title: "Planner Maintenance", meta: "Audit + dedupe", body: renderPlannerMaintenanceSection() },
        { id: "webhooks", title: "Webhook Debugging", meta: "Graph + BC", body: renderWebhookSection(data) },
        { id: "planner-projects", title: "Planner Projects", meta: "Per-project sync", body: renderPlannerProjectsSection() },
  ...
  <div class="hero">
    <div>
      ...
      <div class="small muted">Operational controls for OneDrive, Planner, and Business Central</div>
