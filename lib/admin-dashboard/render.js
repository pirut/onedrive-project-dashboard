  ...
  <head>
    ...
    <style>
      ...
      *{box-sizing:border-box}
      ...
      .scroll-card{max-height:360px;overflow:auto;border:1px solid #1f2a44;border-radius:10px;background:#0b1220}
      .scroll-card table{margin:0}
  ...
  <div class="grid">
    <details class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="small mono">TENANT_ID, MSAL_CLIENT_ID, MICROSOFT_CLIENT_SECRET, DEFAULT_SITE_URL, DEFAULT_LIBRARY</div>
      </div>
    </details>
    <details class="panel">
...
function renderPlannerSyncSection() {
  ...
  <div style="margin-bottom:8px">
    ...
    <a class="badge" href="/api/webhooks-dashboard" style="margin-left:6px">Open Webhook Dashboard</a>
  </div>
  <div class="row">
  ...
  <div class="row" style="display:flex;gap:8px;flex-wrap:wrap">
    <button type="button" id="planner-run-bc">Run BC → Premium</button>
    <button type="button" id="planner-run-bc-reseed" style="background:#ef6c00;color:#fff">Force Recreate Tasks</button>
    <button type="button" id="planner-run-bc-pr00001" style="background:#2b61d1;color:#fff">Run BC → Premium (PR00001)</button>
    <button type="button" id="planner-poll-premium" style="background:#0f8b4c;color:#fff">Run Premium → BC</button>
    <button type="button" id="planner-run-auto" style="background:#1f2a44;color:#e6ecff">Run Auto Sync</button>
...
function renderPlannerProjectsSection() {
  ...
  <div class="row" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:12px">
    ...
    <button type="button" id="planner-projects-bulk-share" style="background:#0f8b4c;color:#fff">Share with team</button>
  ...
  <div class="small muted" style="margin-top:6px">Share with team applies configured access targets (<span class="mono">PLANNER_GROUP_ID</span>/<span class="mono">PLANNER_GROUP_RESOURCE_IDS</span>).</div>
...
function renderPlannerCleanupSection() {
  ...
  <pre id="planner-assets-output" class="log-block" style="display:none;max-height:260px;overflow:auto;margin-bottom:12px"></pre>
  <div class="grid">
    <div>
...
function renderDashboardPage(data) {
  ...
  <div class="hero">
    ...
    <div class="hero-actions">
      <a href="/api/plans-dashboard" class="link-button">Plan Manager</a>
      <a href="/api/share-reminders-dashboard" class="link-button">Project Sharing Manager</a>
