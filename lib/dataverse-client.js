...
export function getDataverseConfig() {
    ...
    const authClientSecret = readEnv("DATAVERSE_AUTH_CLIENT_SECRET") || "";
...
export class DataverseClient {
    ...
    async createProjectV1(project) {
        const payload = {
            Project: project,
        };
        const data = await this.executeAction("msdyn_CreateProjectV1", payload);
        const projectId = (data === null || data === void 0 ? void 0 : data.ProjectId) || (data === null || data === void 0 ? void 0 : data.projectId) || (data === null || data === void 0 ? void 0 : data.projectid) || "";
