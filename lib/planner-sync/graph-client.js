...
export class GraphClient {
    ...
    async listPlannerTasksDelta(deltaLink) {
        const select = "id,title,planId,bucketId,percentComplete,startDateTime,dueDateTime,createdDateTime,lastModifiedDateTime";
        const url = deltaLink
            ? deltaLink
