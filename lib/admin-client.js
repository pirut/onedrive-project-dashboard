    ...
    (function(){
      ...
      function renderPlannerProjects(){
        ...
        var rows = filtered.map(function(item){
          ...
          var lastUpdatedMs = item.lastUpdatedAt ? Date.parse(item.lastUpdatedAt) : NaN;
          var lastUpdatedLabel = formatRelativeTime(lastUpdatedMs);
          var lastUpdatedTitle = item.lastUpdatedAt ? htmlEscape(item.lastUpdatedAt) : '';
          var lastUpdatedCell = lastUpdatedTitle
            ? '<span class="mono small" title="' + lastUpdatedTitle + '">' + htmlEscape(lastUpdatedLabel) + '</span>'
