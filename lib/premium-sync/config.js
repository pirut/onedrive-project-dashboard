...
export function getPremiumSyncConfig() {
    return {
        ...
        deleteBehavior: readEnv("PREMIUM_DELETE_BEHAVIOR") || "clearLink",
...
export function getDataverseMappingConfig() {
    ...
    const taskProjectIdField = readEnv("DATAVERSE_TASK_PROJECT_ID_FIELD") || `_${taskProjectLookupField}_value`;
    return {
