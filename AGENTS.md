...
- Shared tenant: `TENANT_ID`
- BC: `BC_ENVIRONMENT`, `BC_COMPANY_ID`, `BC_CLIENT_ID`, `BC_CLIENT_SECRET`, `BC_API_BASE`,
  `BC_API_PUBLISHER`, `BC_API_GROUP`, `BC_API_VERSION`
- Dataverse: `DATAVERSE_BASE_URL`, `DATAVERSE_CLIENT_ID`, `DATAVERSE_CLIENT_SECRET`, `DATAVERSE_RESOURCE_SCOPE`
