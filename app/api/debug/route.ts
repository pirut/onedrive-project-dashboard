...
export async function GET(request: Request) {
    ...
    const info = {
        ...
        routes: {
            ...
            "POST /api/sync/bc-queue-cron": "Process BC sync queue (cron-safe BC → Premium)",
            ...
            "POST /api/sync/projects": "Toggle Premium project sync / clear links / share project access",
